...
def levelOrder(self, root: Optional[TreeNode]) -> list[list[int]]:
    ...
    step3: no recursion, using of while and forloop to go through and create sublists of every level then adding them to the big
    outer list until we get the dsired representation of the BFS traversal.
